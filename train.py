...
def train(hyp, opt, device, callbacks):  # hyp is path/to/hyp.yaml or hyp dictionary
    ...
    if pretrained:
        ...
        model = Model(cfg or ckpt['model'].yaml, ch=11, nc=nc, anchors=hyp.get('anchors')).to(device)  # create
        ...
        model = Model(cfg, ch=11, nc=nc, anchors=hyp.get('anchors')).to(device)  # create
